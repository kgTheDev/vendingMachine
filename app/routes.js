...
// message board routes ===============================================================
  ...
  //updating inventory with Drink bought from vending
    ...
    // app.put('/inventoryCocktail', (req, res) => {
    //   db.collection('inventory')
    //   .findOneAndUpdate({drink: req.body.drink}, {
    //     $set: {
    //       plus:req.body.cocktail - 1
    //     }
    //   }, {
    //     sort: {_id: -1},
    //     upsert: true
    ...
    // })
    //
    // app.put('/inventoryMartini', (req, res) => {
    //   db.collection('inventory')
    //   .findOneAndUpdate({drink: req.body.drink}, {
    //     $set: {
    //       plus:req.body.martini - 1
    //     }
    //   }, {
    //     sort: {_id: -1},
    //     upsert: true
    ...
    //   db.collection('inventory').findOneAndDelete({drink: req.body.drink, amount: req.body.amount}, (err, result) => {
